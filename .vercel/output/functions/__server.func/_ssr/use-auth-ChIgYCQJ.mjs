...
import { w as LayoutList, x as CalendarDays, y as Settings, z as Plus, X, B as Bell } from "../_libs/lucide-react.mjs";
...
function useAuth() {
  ...
  reactExports.useEffect(() => {
    import("./router-DstwvJOU.mjs").then((n) => n.h).then(({ supabase }) => {
