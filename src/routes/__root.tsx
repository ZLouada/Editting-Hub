...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Editing Hub — Build lasting habits" },
      ...
      { property: "og:title", content: "Editing Hub — Build lasting habits" },
      ...
      { name: "twitter:title", content: "Editing Hub — Build lasting habits" },
