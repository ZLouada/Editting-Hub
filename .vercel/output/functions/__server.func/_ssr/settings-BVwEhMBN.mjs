...
import { u as useAuth, B as BottomNav, A as AddHabitSheet, g as getHabits, a as getLogs, s as saveHabits, b as saveLogs } from "./use-auth-ChIgYCQJ.mjs";
  ...
  const handleClear = async () => {
    ...
    if (user) {
      try {
        const {
          supabase
        } = await import("./router-DstwvJOU.mjs").then((n) => n.h);
