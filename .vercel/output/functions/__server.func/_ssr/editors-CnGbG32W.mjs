...
import { a as Route$4, s as searchEditors, b as searchEditorsFromDb, A as ALL_SPECIALTIES } from "./router-DstwvJOU.mjs";
import { S as SiteHeader, a as SiteFooter } from "./SiteHeader-D0WvB9LN.mjs";
import "../_libs/sonner.mjs";
import { p as Search, q as MapPin, r as Star, g as ArrowRight } from "../_libs/lucide-react.mjs";
...
function EditorsPage() {
  ...
  const fallbackResults = reactExports.useMemo(() => searchEditors(q, specialty), [q, specialty]);
  const [results, setResults] = reactExports.useState(fallbackResults);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-6xl mx-auto px-5 pt-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-col sm:flex-row gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: q, onChange: (e) => {
            setQ(e.target.value);
            setLoaded(false);
          }, placeholder: "Search editors…", className: "w-full rounded-xl border border-input bg-background pl-11 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: specialty, onChange: (e) => {
          setSpecialty(e.target.value);
          setLoaded(false);
        }, className: "rounded-xl border border-input bg-background px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring", children: ALL_SPECIALTIES.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, children: s }, s)) })
      ] }),
